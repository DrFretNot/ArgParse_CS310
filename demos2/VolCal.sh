...
java -cp .:../Library/build/libs/Library-1.0.jar VolumeCalculator 2 --type ellipsoid 3 -d 1 5
java -cp .:../Library/build/libs/Library-1.0.jar VolumeCalculator 2 --type ellipsoid 3 -d value 5